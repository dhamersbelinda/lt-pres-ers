...
import be.uclouvain.lt.pres.ers.server.model.PresRetrieveInfoResponseType;
import be.uclouvain.lt.pres.ers.server.model.PresRetrieveInfoType;
import lombok.AllArgsConstructor;

@Component
@AllArgsConstructor
public class RetrieveInfoApiDelegateImpl implements RetrieveInfoApiDelegate {
