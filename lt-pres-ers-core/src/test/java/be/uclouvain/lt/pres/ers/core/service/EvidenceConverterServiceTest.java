...
public class EvidenceConverterServiceTest {
    ...
    public void conversion() throws URISyntaxException {
        ...
        */
        ...
        POID r = new POID();
        r.setPo(po);
        //when(this.poidRepository.getById(any())).thenReturn(r);
        ...
        evidenceRecordDtoList.add(new EvidenceRecordDto(5L, 2L, "test".getBytes(StandardCharsets.UTF_8), 7L, 0L, Base64.getDecoder().decode(ts),true));
        evidenceRecordDtoList.add(new EvidenceRecordDto(25L, null, "test".getBytes(StandardCharsets.UTF_8), 7L, 0L, Base64.getDecoder().decode(ts),true));
        evidenceRecordDtoList.add(new EvidenceRecordDto(25L, null, "test".getBytes(StandardCharsets.UTF_8), 7L, 0L, Base64.getDecoder().decode(ts),true));
        evidenceRecordDtoList.add(new EvidenceRecordDto(25L, null, "test".getBytes(StandardCharsets.UTF_8), 7L, 0L, Base64.getDecoder().decode(ts),true));
        evidenceRecordDtoList.add(new EvidenceRecordDto(25L, null, "test".getBytes(StandardCharsets.UTF_8), 7L, 0L, Base64.getDecoder().decode(ts),true));
        ...
        EvidenceRecordType.build(evidenceRecordDtoList, r);
    }
}
